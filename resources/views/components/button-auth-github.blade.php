<a href="javascript:;" class="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-gray-500 rounded-md group hover:bg-gray-800 focus:outline-none">
