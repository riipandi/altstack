<x-auth-layout :title="__('Reset Password')">
    <div class="bg-gray-100 text-gray-500 rounded-xl shadow w-full overflow-hidden max-w-4xl">
                    ...
                    <div class="flex flex-col space-y-2 mt-6">
                        <div class="w-full">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="text" id="email" name="email" value="{{ old('email', $request->get('email')) }}" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-md border-2 border-gray-200 outline-none focus:border-primary-500 text-sm" placeholder="Email address" autofocus required>
                            </div>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="password" id="password" name="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-md border-2 border-gray-200 outline-none focus:border-primary-500 text-sm" placeholder="New password" required>
                            </div>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-md border-2 border-gray-200 outline-none focus:border-primary-500 text-sm" placeholder="Confirm new password" required>
                            </div>
                        </div>
