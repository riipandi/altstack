                ...
                <form action="{{ route('password.update') }}" method="POST" autocomplete="off"> @csrf
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-sm mt-4">
                            ...
                            <a href="{{ route('login') }}" class="text-primary-700 hover:text-primary-500">
                                Sign in here &rarr;
                            </a>
                        </p>
                    </div>

                    <x-auth-session-status class="mt-6 text-sm text-gray-600" :status="session('status')" />
                    <x-auth-validation-errors class="mt-6 text-xs px-3 py-2" :errors="$errors" />
                    ...
                    <div class="flex flex-col space-y-2 mt-6">
                        <div class="w-full">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="text" id="email" name="email" value="{{ old('email', $request->get('email')) }}" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-md border-2 border-gray-200 outline-none focus:border-primary-500 text-sm text-gray-900" placeholder="Email address" autofocus required>
                            </div>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="password" id="password" name="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-md border-2 border-gray-200 outline-none focus:border-primary-500 text-sm text-gray-900" placeholder="New password" required>
                            </div>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-md border-2 border-gray-200 outline-none focus:border-primary-500 text-sm text-gray-900" placeholder="Confirm new password" required>
                            </div>
                        </div>
