<x-auth-layout :title="__('Create Account')">
    <div class="w-full max-w-5xl overflow-hidden text-gray-500 bg-white shadow rounded-xl">
            ...
            <div class="w-full px-5 py-10 md:w-1/2 md:px-10">
                <form action="{{ route('register') }}" method="POST" autocomplete="off"> @csrf
                    <div class="text-center">
                        ...
                        <p class="mt-2">Enter your information to create an account</p>
                        <p class="mt-4 text-sm tracking-tight">
                    ...
                    <div class="flex flex-col mt-8 space-y-3">
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}" class="w-full py-2 pl-10 pr-3 -ml-10 text-sm text-gray-900 border-2 border-gray-200 rounded-md outline-none focus:border-primary-500" placeholder="Full name" required>
                            </div>
                        </div>
