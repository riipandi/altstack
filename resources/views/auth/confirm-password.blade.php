    ...
    <div class="w-full max-w-md overflow-hidden text-gray-500 bg-white shadow rounded-xl">
        <div class="w-full md:flex">
            ...
            <div class="w-full px-5 py-10 md:px-10">
                <form action="{{ route('password.confirm') }}" method="POST" autocomplete="off"> @csrf
                    <div class="text-left">
                        <h1 class="text-3xl font-bold text-gray-900">Confirm Password</h1>
                        <p class="mt-4 text-sm">
                            {{ __('This is a secured area, please confirm your password before continuing.') }}
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col mt-6 space-y-4">
                        <div class="w-full">
                            ...
                            <div class="flex">
                                ...
                                <input type="password" id="password" name="password" class="block w-full py-2 pl-10 pr-3 -ml-10 text-gray-600 placeholder-gray-400 border border-gray-300 rounded-md shadow-sm appearance-none focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm" placeholder="Current password" autofocus required>
                            </div>
                        </div>
