                ...
                <form action="{{ route('login') }}" method="POST" autocomplete="off"> @csrf
                    ...
                    <div class="flex flex-col space-y-4 mt-8">
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="password" id="password" name="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-md border-2 border-gray-200 outline-none focus:border-primary-500 text-sm" placeholder="Your password">
                            </div>
                        </div>

                        <div class="pt-3 w-full">
                            <button class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-white border border-transparent rounded-md shadow-sm bg-primary-600 hover:bg-primary-700 focus:outline-none disabled:opacity-25 transition ease-in-out duration-150">
                                <span>Sign in</span>
                                <x-heroicon-s-chevron-double-right class="w-auto h-4 ml-1 -mr-1"/>
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="social-login">
                        ...
                        <div class="grid grid-cols-2 gap-4 my-2">
                            <div id="auth-with-github">
                                <x-button-auth-github />
                            </div>
                            <div id="auth-with-twitter">
                                <x-button-auth-twitter />
                            </div>
                        </div>
                    </div>
                </form>
