<x-auth-layout :title="__('Sign in')">
    <div class="w-full max-w-lg overflow-hidden text-gray-500 bg-gray-100 shadow rounded-xl">
        <div class="w-full md:flex">
            {{-- <div class="hidden w-1/2 px-10 py-10 md:block bg-primary-500">
            ...
            <div class="w-full px-5 py-10 md:px-10">
                <form action="{{ route('login') }}" method="POST" autocomplete="off"> @csrf
                    ...
                    <x-auth-validation-errors class="px-3 py-2 mt-8 text-xs" :errors="$errors" />
                    ...
                    <div class="flex flex-col mt-8 space-y-4">
                        ...
                        <div class="w-full">
                            <div class="flex justify-between">
                                <label for="password" class="px-1 text-sm font-medium tracking-tight">Password:</label>
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="password" id="password" name="password" class="w-full py-2 pl-10 pr-3 -ml-10 text-sm text-gray-900 border-2 border-gray-200 rounded-md outline-none focus:border-primary-500" placeholder="Your password">
                            </div>
                        </div>

                        <div class="w-full pt-3">
                            <button class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md shadow-sm bg-primary-600 hover:bg-primary-700 focus:outline-none disabled:opacity-25">
                                <span>Sign in</span>
                    ...
                    <div id="social-login">
                        <div class="relative my-8">
                            ...
                            <div class="relative flex justify-center">
                                <span class="px-2 text-sm text-gray-500 bg-gray-100">
