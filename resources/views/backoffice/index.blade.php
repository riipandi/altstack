...
<div class="md:max-w-6xl md:mx-auto px-4 py-8">
    ...
    <div class="bg-orange-200 mb-10 p-6 rounded-lg shadow">
        <div class="md:flex">
            <div class="md:w-1/2">
                <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-2 leading-tight">Power your business with {{ config('app.name') }}.</h2>
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="javascript:;" class="text-blue-600 hover:text-blue-500 font-medium">View all</a>
    </div>
    <div class="overflow-x-auto bg-white rounded-lg shadow">
        <table class="w-full whitespace-no-wrap bg-white overflow-hidden table-striped">
            <thead>
                <tr class="text-left">
                    <th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-sm">Invoice</th>
                    <th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-sm">Name</th>
                    <th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-sm">Date</th>
                    <th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-sm text-right">Amount</th>
                    <th class="px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-sm">Status</th>
                </tr>
            </thead>
            <tbody>
                <tr class="focus-within:bg-gray-200 overflow-hidden">
                    ...
                    <td class="border-t">
                        <span class="px-6 py-4 flex items-center">
                            <span class="px-2 rounded-full text-xs uppercase tracking-wide font-semibold bg-green-200 text-green-800">Completed</span>
                        </span>
                    </td>
                </tr>
                ...
                <tr class="focus-within:bg-gray-200 overflow-hidden">
                    ...
                    <td class="border-t">
                        <span class="px-6 py-4 flex items-center">
                            <span class="px-2 rounded-full text-xs uppercase tracking-wide font-semibold bg-orange-200 text-orange-800">Pending</span>
                        </span>
                    </td>
                </tr>
                ...
                <tr class="focus-within:bg-gray-200 overflow-hidden">
                    ...
                    <td class="border-t">
                        <span class="px-6 py-4 flex items-center">
                            <span class="px-2 rounded-full text-xs uppercase tracking-wide font-semibold bg-blue-200 text-blue-800">Processing</span>
                        </span>
                    </td>
                </tr>
